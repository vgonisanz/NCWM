#ifndef _LOGGER_HEADER_FILE_H
#define _LOGGER_HEADER_FILE_H

#define USE_NCWM_DEBUG_LOGS 1

#ifdef USE_NCWM_DEBUG_LOGS
// Check LOG_TAG is defined
#ifndef LOG_TAG
	#warning("define LOG_TAG string to identify current source.")
#endif
// TODO Check extension file must no a h or hxx, must be c or cpp only
// YES LOGS
#	ifdef ANDROID
	// LOGS ANDROID
...
#	define LOGW(...)
#	define LOGE(...)
#endif // USE_NCWM_DEBUG_LOGS

#endif  /* _LOGGER_HEADER_FILE_H */
